...
from app.models import (
    ComercialActivityLog, ComercialComment, ComercialFriction, ComercialKpi,
    ComercialKpiFriction, ComercialKpiHistory, ComercialKpiTouchpoint,
    ComercialPerson, ComercialPhase, ComercialTouchpoint, ComercialTpKpiHistory,
...
from app.serialize import (
    comercial_activity_log_out, comercial_comment_out, comercial_friction_out,
